...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "stellar_defenders_pygame_module.py"

        #Name of program
        self.project_name = "StellarDefenders"
        ...
        #Auhor of program
        self.author_name = "SUPERNOOB20"
        self.author_email = "example@example.com"
        self.copyright = "Copyright (c) 2024 - 2025 SUPERNOOB20."

        #Description
        self.project_description = "Visual novel - indie game :3"
