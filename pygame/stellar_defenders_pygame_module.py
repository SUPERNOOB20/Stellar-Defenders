...
while True:     # EVERYTHING INSIDE THIS LOOP IS IN THE EVENT LOOP
    ...
    if tick_precounter == 0:
        ...
        from colour_collider_handler import colours_init
        colours_init()
        print("Bulky animations and colour colliders initialized succesfully :)")
        ...
        animation_handler(screen, tick_counter, "none")     # Think of it as a "timeline" in video editing software! :3
