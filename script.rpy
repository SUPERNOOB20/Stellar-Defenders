...
label start:
    ...
    python:
        ...
        subprocess.run("python.exe world_map_handler.py", cwd = f"{renpy_boot_path}/Stellar Defenders/game/python-packages", creationflags = DETACHED_PROCESS)
        os.chdir(f"{renpy_boot_path}")
